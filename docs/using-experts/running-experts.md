...
Each invocation creates a new **Job** containing one or more **Runs**. See [State Management](./state-management.md) for details on the execution hierarchy.
...
For the complete list of options, see [CLI Reference](../references/cli.md).

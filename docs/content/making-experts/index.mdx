...
- [Examples](/making-experts/examples) — real-world use cases
...
- [Base Skill](/making-experts/base-skill) — built-in tools provided by the runtime
- [Testing](/making-experts/testing) — strategies for testing Experts
- [Publishing](/making-experts/publishing) — share Experts via the Registry
...
- [Experts](/understanding-perstack/experts) — what Experts are and how they work
- [Getting Started](/getting-started) — build your first Expert

For running and integrating Experts, see [Using Experts](/using-experts).

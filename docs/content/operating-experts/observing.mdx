...
For the full event schema and state machine, see [Runtime](/understanding-perstack/runtime#internal-state-machine).
...
See [Runtime](/understanding-perstack/runtime#the-perstack-directory) for the full directory structure.

...
When a Delegated Expert fails, the Job continues — the error is returned to the Coordinator, which decides how to handle it. See [Delegation failure handling](/understanding-perstack/experts#delegation-failure-handling) for details.

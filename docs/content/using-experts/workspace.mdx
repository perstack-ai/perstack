...
The runtime stores execution history in `perstack/jobs/` within the workspace. This directory is managed automatically — see [Runtime](/understanding-perstack/runtime#the-perstack-directory) for details.

...
Expert definitions are plain text with no framework dependency. Any agent framework can consume them through the [Registry API](/references/registry-api). The ecosystem is open.
...
<Cards>
  <Cards.Card
    title="Experts"
    href="/understanding-perstack/experts"
  />
  <Cards.Card
    title="Runtime"
    href="/understanding-perstack/runtime"
  />
  <Cards.Card
    title="Registry"
    href="/understanding-perstack/registry"
  />
  <Cards.Card
    title="Sandbox Integration"
    href="/understanding-perstack/sandbox-integration"
  />
</Cards>
...
This isn't just for debugging. Observability is a [prerequisite for sandbox-first security](/understanding-perstack/sandbox-integration#observability-as-a-prerequisite) — you verify behavior after the fact, not before.

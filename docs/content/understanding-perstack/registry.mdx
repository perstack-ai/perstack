...
For detailed instructions, see [Publishing Experts](/making-experts/publishing).
...
Registry security is one layer of defense. See [Sandbox Integration](/understanding-perstack/sandbox-integration) for the full security model.

## API Reference

For programmatic access, see [Registry API Reference](/references/registry-api).

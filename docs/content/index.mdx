...
<Cards>
  <Cards.Card title="Get Started →" href="/getting-started" />
  <Cards.Card title="Browse Registry →" href="https://platform.perstack.ai/" />
</Cards>
...
- [Getting Started](/getting-started) — run your first Expert in 5 minutes
- [Understanding Perstack](/understanding-perstack/concept) — learn core concepts
- [Making Experts](/making-experts) — define and develop Experts
- [Using Experts](/using-experts) — run and integrate Experts

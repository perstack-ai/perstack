...
See [Providers and Models](/references/providers-and-models) for other providers.
...
For more on skills, see [Skills](/making-experts/skills).
...
See [Sandbox Integration](/understanding-perstack/sandbox-integration) for the full rationale.
...
- [Rapid Prototyping](/working-with-perstack/rapid-prototyping) — validate ideas without writing code
- [Taming Prompt Sprawl](/working-with-perstack/taming-prompt-sprawl) — fix bloated prompts with modular Experts
- [Adding AI to Your App](/working-with-perstack/adding-ai-to-your-app) — integrate Experts into existing applications
- [Going to Production](/working-with-perstack/going-to-production) — deploy safely with Docker isolation

**Understand the architecture:**
- [Concept](/understanding-perstack/concept) — why isolation and observability matter
- [Experts](/understanding-perstack/experts) — best practices for Expert design

**Build more:**
- [Making Experts](/making-experts) — full `perstack.toml` guide
- [Skills](/making-experts/skills) — MCP integration patterns

**Reference:**
- [CLI Reference](/references/cli) — all commands and options
- [perstack.toml Reference](/references/perstack-toml) — complete configuration spec

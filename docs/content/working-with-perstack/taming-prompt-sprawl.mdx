...
Your existing tools (database access, APIs, etc.) become MCP skills. See [Extending with Tools](/working-with-perstack/extending-with-tools).
</Callout>
...
- [Experts](/understanding-perstack/experts) — How delegation works in detail
- [Best Practices](/making-experts/best-practices) — Design patterns for splitting Experts
- [Adding AI to Your App](/working-with-perstack/adding-ai-to-your-app) — Integrate your modular agents
